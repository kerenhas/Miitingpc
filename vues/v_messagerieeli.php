	...
	<div class="sous-menu">
		...
		<div class="container">
			<div class="header">
				...
				<a class="btn btn-outline-danger" id="myBtn">Contacter</a>
		...
		<div id="myModal" class="modal">
			...
			<input name="fichier" id="fichier" type="file" class="form-control-file" >
									...
									<h3>Message :<textarea class="form-control" placeholder="Ecrivez votre message" id="message" type="text" name="message"></textarea></h3>
					</div>
					<center><button class="btn btn-primary" type="submit" href="#" name="nouvelleconnexion">Envoyer</button></center>
					</form>
				</div>
