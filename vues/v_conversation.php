...
<!-- Faire une entete pour chaque conversation avec le nom du prestataire, le titre de l'evenement  -->
<h3 class='ctr policeNewRoman'><?php echo $libelleEvent[0]['libelle']." - ". $libelleEvent[0]['libtype'];?></h3>
